...
<body>
    <nav class="site-header">
        <div class="site-nav-container">
            ...
            <div class="site-nav-links">
                ...
                <a href="admin_seller.php" class="nav-link active">Sellers</a>
    ...
    <div class="container">
        ...
        <div class="profile-nav">
            ...
            <button class="nav-btn active" >Seller</button>
        ...
        <tbody>
            ...
            $sql = "SELECT id, username, email, mobile FROM seller_registration";
            $result = $conn->query($sql);
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr>
                            ...
                            <td>".$row["mobile"]."</td>
                            <td>
                            <a href='../Controller/delete_seller.php?id={$id}' class='delete-btn' 
